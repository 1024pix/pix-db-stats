...
DEFAULT_PG_CONNECTIONS_ACTIVITY_SCHEDULE = '0 */10 * * * *';
...
const config = {
  ...
  PG_CONNECTIONS_ACTIVITY_SCHEDULE: process.env.PG_CONNECTIONS_ACTIVITY_SCHEDULE || DEFAULT_PG_CONNECTIONS_ACTIVITY_SCHEDULE
};
